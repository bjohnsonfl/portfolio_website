  ...
  <Layout headerDelay = {500}>
   ...
   <div className ="projects_Header"> <Fade><h1>Projects</h1></Fade></div>
    ...
    <div className = "landing_Page_Projects">
        ...
        <Fade><div className ="tile"> <ProjectDescriptionTile projectName="Overhead" project = "Overhead">Sed iaculis mi in urna lacinia gravida. Praesent id consequat massa. Mauris vel pharetra quam, eget auctor ante. Donec ultrices tincidunt ultricies. In hac habitasse platea dictumst. </ProjectDescriptionTile></div></Fade>
    
        <Fade duration = {2000}><div className = "projectImg"><img src = {iphonePic} alt = "iPhone Picture" /></div></Fade>
        <Fade><div className ="tile"> <ProjectDescriptionTile projectName="iPhone" project = "Lorem Ipsum">Morbi dictum dui lectus, nec ullamcorper quam vulputate ac. Nulla efficitur libero leo, eu lacinia odio faucibus sit amet.</ProjectDescriptionTile></div></Fade>
    
        <Fade duration = {2000}><div className = "projectImg"><img src = {J_typePic} alt = "Mips Picture" /></div></Fade>
        <Fade><div className ="tile"> <ProjectDescriptionTile projectName="Mips" project = "MIPS Processor">Integer molestie iaculis consectetur. Quisque non diam arcu. Nam sed euismod quam. Etiam imperdiet dolor enim, vel imperdiet purus maximus.</ProjectDescriptionTile></div></Fade>
    </div>
